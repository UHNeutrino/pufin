...
void nusystest(){
    ...
    // // ############################################################
    // TFile genie_file(Genie_file); //String for Genie event record preflattened gen
    ...
    // // genie_file.Close();
    // nusyst::response_helper* resp = new nusyst::response_helper(fcl_file);
    // // // ###########################################################################
    ...
    //     // std::cout << resp->GetSpline(systID, Events_stand).Eval(x) << std::endl;
