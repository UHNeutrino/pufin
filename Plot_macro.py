...
for file in root_files:
    ...
    ParticlePlots.Plot1PI(x,y,histInfo1,"1PI_hist_max",file_path, max = .06, Normalize = 1)
    ...
    ParticlePlots.Plot2P2H(x,y,histInfo2,"2P2H_hist_max",file_path, max = .03, Normalize=1)
