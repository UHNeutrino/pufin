...
for file in root_files:
    ...
    ParticlePlots.Plot1PI(x,y,histInfo1,"1PI_hist",file_path)p
    ParticlePlots.Plot1PI(x,y,histInfo1,"1PI_hist_max",file_path, max = .035, Normalize=1)
    ...
    ParticlePlots.Plot2P2H(x,y,histInfo2,"2P2H_hist_max",file_path, max = .016, Normalize = 1)
